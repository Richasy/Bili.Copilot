...
unsafe public partial class Renderer
{
    ...
    internal bool ConfigPlanes(bool isNewInput = true)
    {
        ...
        try
        {
            Monitor.Enter(VideoDecoder._lockCodecCtx);
            ...
            VideoProcessor = !VideoDecoder.VideoAccelerated || D3D11VPFailed || Config.Video.VideoProcessor == VideoProcessor.Flyleaf || (Config.Video.VideoProcessor == VideoProcessor.Auto && IsHDR && !Config.Video.Deinterlace) ? VideoProcessor.Flyleaf : VideoProcessor.D3D11;
...
");
        ...
        finally
        {
            ...
            Monitor.Exit(VideoDecoder._lockCodecCtx);
        }
    }
