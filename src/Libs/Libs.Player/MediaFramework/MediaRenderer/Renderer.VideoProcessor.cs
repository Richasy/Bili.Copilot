...
public unsafe partial class Renderer
{
    ...
    void InitializeFilters()
    {
        ...
        if (VideoProcessor == Enums.VideoProcessor.Flyleaf)
        {
    ...
    internal void UpdateDeinterlace()
    {
        lock (lockDevice)
        {
            ...
            if (Config.Video.VideoProcessor != VideoProcessor.Auto)
                return;
    ...
    internal void UpdateVideoProcessor()
    {
        ...
        if (Config.Video.VideoProcessor == VideoProcessor || (Config.Video.VideoProcessor == VideoProcessor.D3D11 && D3D11VPFailed))
            return;
...
public class VideoFilter : ObservableObject
{
    ...
    public VideoFilters Filter { get => _Filter; set => SetProperty(ref _Filter, value); }
    VideoFilters _Filter = VideoFilters.Brightness;

    public int Minimum { get => _Minimum; set => SetProperty(ref _Minimum, value); }
    int _Minimum = 0;
    ...
    public int Value { get => _Value; set { if (SetProperty(ref _Value, value)) renderer?.UpdateFilterValue(this); } }
    int _Value = 50;

    internal void SetValue(int value) => SetProperty(ref _Value, value, nameof(Value));

    public VideoFilter() { }
    public VideoFilter(VideoFilters filter, MediaPlayer.Player player = null)
        => Filter = filter;
}
