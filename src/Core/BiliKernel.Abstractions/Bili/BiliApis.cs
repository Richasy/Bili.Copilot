...
{
    private const string _apiBase = "https://api.bilibili.com";
    private const string _appBase = "https://app.bilibili.com";
    private const string _vcBase = "https://api.vc.bilibili.com";
    private const string _liveBase = "https://api.live.bilibili.com";
    private const string _passBase = "https://passport.bilibili.com";
    private const string _passSnmBase = "https://passport.snm0516.aisee.tv";
    private const string _bangumiBase = "https://bangumi.bilibili.com";
    private const string _grpcBase = "https://grpc.biliapi.net";

    private const string CookieGetDomain = "https://www.bilibili.com";
    private const string CookieSetDomain = "bilibili.com";
