...
/// 会话列表响应.
/// </summary>
internal sealed class ChatSessionListResponse
{
    /// <summary>
    /// 会话列表.
    /// </summary>
    [JsonPropertyName("session_list")]
    public IList<BiliChatSession>? SessionList { get; set; }
...
internal sealed class ChatMessageResponse
{
    ...
    public IList<BiliChatMsg>? MessageList { get; set; }
    ...
    public IList<ChatEmoteInfo>? EmoteInfos { get; set; }
}
...
/// 表情信息.
/// </summary>
internal sealed class ChatEmoteInfo
{
    /// <summary>
    /// 文本.
    /// </summary>
...
/// 会话.
/// </summary>
internal sealed class BiliChatSession
{
    /// <summary>
    /// 发起者 Id.
    /// </summary>
...
/// 聊天消息.
/// </summary>
internal sealed class BiliChatMsg
{
    /// <summary>
    /// 发送方 Id.
    /// </summary>
