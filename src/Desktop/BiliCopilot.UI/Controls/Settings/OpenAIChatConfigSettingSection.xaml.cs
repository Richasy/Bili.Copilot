...
/// OpenAI 聊天配置设置部分.
/// </summary>
public sealed partial class OpenAIChatConfigSettingSection : AIServiceConfigControlBase
{
    /// <summary>
    /// Initializes a new instance of the <see cref="OpenAIChatConfigSettingSection"/> class.
    /// </summary>
