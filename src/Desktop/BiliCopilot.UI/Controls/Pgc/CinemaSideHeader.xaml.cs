...
/// 影院侧边栏头部.
/// </summary>
public sealed partial class CinemaSideHeader : CinemaPageControlBase
{
    /// <summary>
    /// Initializes a new instance of the <see cref="CinemaSideHeader"/> class.
    /// </summary>
    public CinemaSideHeader() => InitializeComponent();
