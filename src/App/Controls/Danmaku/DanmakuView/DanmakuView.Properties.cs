...
public sealed partial class DanmakuView
{
    ...
    {
        get => (double)GetValue(DanmakuSizeZoomProperty);
    ...
    {
        get => (int)GetValue(DanmakuDurationProperty);
    ...
    {
        get => (bool)GetValue(DanmakuBoldProperty);
    ...
    {
        get => (string)GetValue(DanmakuFontFamilyProperty);
    ...
    {
        get => (DanmakuStyle)GetValue(DanmakuStyleProperty);
    ...
    {
        get => (double)GetValue(DanmakuAreaProperty);
